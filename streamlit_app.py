...
st.markdown(
    ">  **Disclaimer:** The demo button uses synthetic, randomly generated data for illustration only. "
    " As you can see it is not based on real financial markets. However the program will still work with real CSV files"
)
